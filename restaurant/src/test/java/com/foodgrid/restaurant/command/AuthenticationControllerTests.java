...
import com.foodgrid.restaurant.command.internal.rest.AuthenticationController;
...
class AuthenticationControllerTests {
    ...
    void signupUser() {
        ...
        var signUpRequest = new RestaurantSignUp("test", "test@test.com", "test", "1234567890");
    ...
    void deleteMe() {
        when(restaurantAuthenticationService.deleteMe()).thenReturn(new GenericIdResponse("1", "Deleted successfully.."));
