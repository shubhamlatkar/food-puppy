...
FROM openjdk:16-jdk-alpine as services
...
ENTRYPOINT ["/bin/sh", "-c", "sleep 40 && java -cp app:app/configuration/target/dependency/BOOT-INF/lib/* app/configuration/target/dependency//BOOT-INF/classes/com.foodgrid.configuration.ConfigurationApplication"] services
